---
title: "seed_alumnos — Reset and seed the database"
sidebarTitle: "seed_alumnos"
description: "NATS message pattern to truncate the alumnos table and load 100 sample student records. Returns count of inserted records."
---
