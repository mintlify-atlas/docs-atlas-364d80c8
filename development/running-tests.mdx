---
title: "Unit and end-to-end tests in ms-alumnos microservice"
sidebarTitle: "Tests"
description: "How to run unit and end-to-end tests for ms-alumnos using Jest, ts-jest, and the NestJS testing utilities — including coverage reports."
---
